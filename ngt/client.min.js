...
var t, n, r, i;
(n = t || (t = {})).WebVisit = "web:visit", n.WebPing = "web:ping", (i = r || (r = {})).Topic = "topic", i.Category = "category", i.Keyword = "keyword", i.SixSenseSegment = "sixsense_segment";
class a {
  all() {
  ...
  get(e2, t2 = null) {
    var _a2;
    return ((_a2 = this.all().find(({ event: t3 }) => t3 === this.getPropertyEvent(e2))) == null ? void 0 : _a2.value) ?? t2;
  }
  set(e2, t2) {
...
function u(e2, t2, n2) {
  if (n2 || 2 === arguments.length)
    for (var r2, i2 = 0, a2 = t2.length; i2 < a2; i2++)
...
function h(e2, t2, n2) {
  return void 0 === n2 && (n2 = 16), c(this, void 0, void 0, function() {
    ...
    return s(this, function(c2) {
      switch (c2.label) {
        case 0:
          r2 = Array(e2.length), i2 = Date.now(), a2 = 0, c2.label = 1;
        case 1:
          return a2 < e2.length ? (r2[a2] = t2(e2[a2], a2), (o2 = Date.now()) >= i2 + n2 ? (i2 = o2, [4, d(0)]) : [3, 3]) : [3, 4];
        case 2:
          c2.sent(), c2.label = 3;
        case 3:
          return ++a2, [3, 1];
...
function L(e2) {
  return e2 = w(e2, [0, e2[0] >>> 1]), e2 = w(e2 = y(e2, [4283543511, 3981806797]), [0, e2[0] >>> 1]), e2 = w(e2 = y(e2, [3301882366, 444984403]), [0, e2[0] >>> 1]);
}
function k(e2) {
  return parseInt(e2);
}
...
function C(e2, t2, n2) {
  var r2 = Object.keys(e2).filter(function(e3) {
    ...
    return function(e3, t3) {
      var n4 = new Promise(function(n5) {
        var r3 = Date.now();
        f(e3.bind(null, t3), function() {
          for (var e4 = [], t4 = 0; t4 < arguments.length; t4++)
            e4[t4] = arguments[t4];
          var i3 = Date.now() - r3;
          if (!e4[0])
            return n5(function() {
              return { error: Z(e4[1]), duration: i3 };
            });
          var a2 = e4[1];
            ...
            return new Promise(function(e5) {
              ...
              f(a2, function() {
                for (var n6 = [], r4 = 0; r4 < arguments.length; r4++)
                  n6[r4] = arguments[r4];
                var a3 = i3 + Date.now() - t5;
                if (!n6[0])
                  return e5({ error: Z(n6[1]), duration: a3 });
                e5({ value: n6[1], duration: a3 });
              });
            });
          });
        });
      ...
      return s(this, function(o2) {
        switch (o2.label) {
          case 0:
            return [4, i2];
          case 1:
            return [4, h(o2.sent(), function(e4) {
              var t4 = e4();
              return v(t4), t4;
            })];
          case 2:
            return e3 = o2.sent(), [4, Promise.all(e3)];
          case 3:
            for (t3 = o2.sent(), n3 = {}, a2 = 0; a2 < r2.length; ++a2)
              n3[r2[a2]] = t3[a2];
            return [2, n3];
        }
      });
...
function M() {
  ...
  return x(["MSCSSMatrix" in e2, "msSetImmediate" in e2, "msIndexedDB" in e2, "msMaxTouchPoints" in t2, "msPointerEnabled" in t2]) >= 4;
}
function I() {
  var e2 = window, t2 = navigator;
  return x(["webkitPersistentStorage" in t2, "webkitTemporaryStorage" in t2, 0 === t2.vendor.indexOf("Google"), "webkitResolveLocalFileSystemURL" in e2, "BatteryManager" in e2, "webkitMediaStream" in e2, "webkitSpeechGrammar" in e2]) >= 5;
}
function A() {
  var e2 = window, t2 = navigator;
  return x(["ApplePayError" in e2, "CSSPrimitiveValue" in e2, "Counter" in e2, 0 === t2.vendor.indexOf("Apple"), "getStorageUpdates" in t2, "WebKitMediaKeys" in e2]) >= 4;
}
function F() {
  var e2 = window;
  return x(["safari" in e2, !("DeviceMotionEvent" in e2), !("ongestureend" in e2), !("standalone" in navigator)]) >= 3;
}
function Y() {
  var e2 = document;
...
function R() {
  var e2 = I(), t2 = function() {
    var e3, t3, n3 = window;
    return x(["buildID" in navigator, "MozAppearance" in (null !== (t3 = null === (e3 = document.documentElement) || void 0 === e3 ? void 0 : e3.style) && void 0 !== t3 ? t3 : {}), "onmozfullscreenchange" in n3, "mozInnerScreenX" in n3, "CSSMozDocumentRule" in n3, "CanvasCaptureMediaStream" in n3]) >= 4;
  }();
  if (!e2 && !t2)
    return false;
  var n2 = window;
  return x(["onorientationchange" in n2, "orientation" in n2, e2 && !("SharedWorker" in n2), t2 && /android/i.test(navigator.appVersion)]) >= 2;
}
function j(e2) {
  var t2 = new Error(e2);
      ...
      switch (s2.label) {
        ...
        case 4:
          return s2.trys.push([4, , 10, 11]), [4, new Promise(function(e3, n3) {
            ...
            c2.onload = i3, c2.onerror = function(e4) {
              r3 = true, n3(e4);
            };
            var a3 = c2.style;
            a3.setProperty("display", "block", "important"), a3.position = "absolute", a3.top = "0", a3.left = "0", a3.visibility = "hidden", t2 && "srcdoc" in c2 ? c2.srcdoc = t2 : c2.src = "about:blank", o2.body.appendChild(c2);
            var s3 = function() {
              var e4, t3;
              r3 || ("complete" === (null === (t3 = null === (e4 = c2.contentWindow) || void 0 === e4 ? void 0 : e4.document) || void 0 === t3 ? void 0 : t3.readyState) ? i3() : setTimeout(s3, 10));
            };
            s3();
          })];
        case 5:
...
function X(e2) {
  for (var t2 = function(e3) {
    for (var t3, n3, r3 = "Unexpected syntax '".concat(e3, "'"), i3 = /^\s*([a-z-]*)(.*)$/i.exec(e3), a3 = i3[1] || void 0, o3 = {}, c3 = /([.:#][\w-]+|\[.+?\])/gi, s3 = function(e4, t4) {
      o3[e4] = o3[e4] || [], o3[e4].push(t4);
    }; ; ) {
      var u2 = c3.exec(i3[2]);
      if (!u2)
        break;
    ...
    return [a3, o3];
  }(e2), n2 = t2[0], r2 = t2[1], i2 = document.createElement(null != n2 ? n2 : "div"), a2 = 0, o2 = Object.keys(r2); a2 < o2.length; a2++) {
    var c2 = o2[a2], s2 = r2[c2].join(" ");
    "style" === c2 ? J(i2.style, s2) : i2.setAttribute(c2, s2);
  }
  return i2;
}
function J(e2, t2) {
  for (var n2 = 0, r2 = t2.split(";"); n2 < r2.length; n2++) {
    var i2 = r2[n2], a2 = /^\s*([\w-]+)\s*:\s*(.+?)(\s*!([\w-]+))?\s*$/.exec(i2);
    if (a2) {
      var o2 = a2[1], c2 = a2[2], s2 = a2[4];
      e2.setProperty(o2, c2, s2 || "");
    }
  }
}
var P = ["monospace", "sans-serif", "serif"], H = ["sans-serif-thin", "ARNO PRO", "Agency FB", "Arabic Typesetting", "Arial Unicode MS", "AvantGarde Bk BT", "BankGothic Md BT", "Batang", "Bitstream Vera Sans Mono", "Calibri", "Century", "Century Gothic", "Clarendon", "EUROSTILE", "Franklin Gothic", "Futura Bk BT", "Futura Md BT", "GOTHAM", "Gill Sans", "HELV", "Haettenschweiler", "Helvetica Neue", "Humanst521 BT", "Leelawadee", "Letter Gothic", "Levenim MT", "Lucida Bright", "Lucida Sans", "Menlo", "MS Mincho", "MS Outlook", "MS Reference Specialty", "MS UI Gothic", "MT Extra", "MYRIAD PRO", "Marlett", "Meiryo UI", "Microsoft Uighur", "Minion Pro", "Monotype Corsiva", "PMingLiU", "Pristina", "SCRIPTINA", "Segoe UI Light", "Serifa", "SimHei", "Small Fonts", "Staccato222 BT", "TRAJAN PRO", "Univers CE 55 Medium", "Vrinda", "ZWAdobeF"];
function D(e2) {
  return e2.toDataURL();
}
var N, E, T = 2500;
function z() {
  ...
  return function() {
    if (void 0 === E) {
      var e3 = function() {
        var t2 = B();
        O(t2) ? E = setTimeout(e3, T) : (N = t2, E = void 0);
      };
      e3();
    }
  }(), function() {
    return c(e2, void 0, void 0, function() {
      var e3;
      return s(this, function(t2) {
        switch (t2.label) {
          case 0:
            return O(e3 = B()) ? N ? [2, u([], N, true)] : (n2 = document).fullscreenElement || n2.msFullscreenElement || n2.mozFullScreenElement || n2.webkitFullscreenElement ? [4, Y()] : [3, 2] : [3, 2];
          case 1:
            t2.sent(), e3 = B(), t2.label = 2;
          case 2:
            return O(e3) || (N = e3), [2, e3];
        }
        var n2;
      });
    });
...
function B() {
  var e2 = screen;
  return [S(V(e2.availTop), null), S(V(e2.width) - V(e2.availWidth) - S(V(e2.availLeft), 0), null), S(V(e2.height) - V(e2.availHeight) - S(V(e2.availTop), 0), null), S(V(e2.availLeft), null)];
}
function O(e2) {
...
function U(e2) {
  ...
  return c(this, void 0, void 0, function() {
    ...
    return s(this, function(s2) {
      switch (s2.label) {
        case 0:
          for (n2 = document, r2 = n2.createElement("div"), i2 = new Array(e2.length), a2 = {}, Q(r2), u2 = 0; u2 < e2.length; ++u2)
            "DIALOG" === (o2 = X(e2[u2])).tagName && o2.show(), Q(c2 = n2.createElement("div")), c2.appendChild(o2), r2.appendChild(c2), i2[u2] = o2;
          s2.label = 1;
        case 1:
        ...
        case 3:
          ...
          try {
            for (u2 = 0; u2 < e2.length; ++u2)
              i2[u2].offsetParent || (a2[e2[u2]] = true);
          } finally {
            null === (t2 = r2.parentNode) || void 0 === t2 || t2.removeChild(r2);
          }
          return [2, a2];
      }
    });
...
var re = Math, ie = function() {
  return 0;
};
var ae = { default: [], apple: [{ font: "-apple-system-body" }], serif: [{ fontFamily: "serif" }], sans: [{ fontFamily: "sans-serif" }], mono: [{ fontFamily: "monospace" }], min: [{ fontSize: "1px" }], system: [{ fontFamily: "system-ui" }] };
var oe = { fonts: function() {
  return G(function(_, e2) {
    var t2 = e2.document, n2 = t2.body;
    n2.style.fontSize = "48px";
    var r2 = t2.createElement("div"), i2 = {}, a2 = {}, o2 = function(e3) {
      var n3 = t2.createElement("span"), i3 = n3.style;
      return i3.position = "absolute", i3.top = "0", i3.left = "0", i3.fontFamily = e3, n3.textContent = "mmMwWLliI0O&1", r2.appendChild(n3), n3;
    }, c2 = P.map(o2), s2 = function() {
      for (var e3 = {}, t3 = function(t4) {
        e3[t4] = P.map(function(e4) {
          return function(e5, t5) {
            return o2("'".concat(e5, "',").concat(t5));
          }(t4, e4);
        });
      }, n3 = 0, r3 = H; n3 < r3.length; n3++) {
        t3(r3[n3]);
      }
      return e3;
    }();
    n2.appendChild(r2);
    for (var u2 = 0; u2 < P.length; u2++)
      i2[P[u2]] = c2[u2].offsetWidth, a2[P[u2]] = c2[u2].offsetHeight;
    return H.filter(function(e3) {
      return t3 = s2[e3], P.some(function(e4, n3) {
        return t3[n3].offsetWidth !== i2[e4] || t3[n3].offsetHeight !== a2[e4];
      });
      var t3;
    });
  });
  ...
  return function(e2, t2) {
    ...
    return G(function(_, n2) {
      ...
      a2.width = "".concat(t2, "px"), a2.webkitTextSizeAdjust = a2.textSizeAdjust = "none", I() ? i2.style.zoom = "".concat(1 / n2.devicePixelRatio) : A() && (i2.style.zoom = "reset");
      var o2 = r2.createElement("div");
      return o2.textContent = u([], Array(t2 / 20 | 0), true).map(function() {
        return "word";
      }).join(" "), i2.appendChild(o2), e2(r2, i2);
    }, '<!doctype html><html><head><meta name="viewport" content="width=device-width, initial-scale=1">');
  }(function(e2, t2) {
    for (var n2 = {}, r2 = {}, i2 = 0, a2 = Object.keys(ae); i2 < a2.length; i2++) {
      var o2 = a2[i2], c2 = ae[o2], s2 = c2[0], u2 = void 0 === s2 ? {} : s2, l2 = c2[1], d2 = void 0 === l2 ? "mmMwWLliI0fiflO&1" : l2, m2 = e2.createElement("span");
      m2.textContent = d2, m2.style.whiteSpace = "nowrap";
      for (var f2 = 0, h2 = Object.keys(u2); f2 < h2.length; f2++) {
        var v2 = h2[f2], p2 = u2[v2];
        void 0 !== p2 && (m2.style[v2] = p2);
      }
      n2[o2] = m2, t2.appendChild(e2.createElement("br")), t2.appendChild(m2);
    }
    for (var y2 = 0, b2 = Object.keys(ae); y2 < b2.length; y2++) {
  ...
  if (A() && !F() && !function() {
    var e3 = window;
    return x(["DOMRectList" in e3, "RTCPeerConnectionIceEvent" in e3, "SVGGeometryElement" in e3, "ontransitioncancel" in e3]) >= 3;
  }())
    return -1;
  var n2 = new t2(1, 5e3, 44100), r2 = n2.createOscillator();
  ...
  var a2 = function(e3) {
    var t3 = 3, n3 = 500, r3 = 500, i3 = 5e3, a3 = function() {
      ...
      var d2 = function() {
        ...
        try {
          var r4 = e3.startRendering();
          switch (m(r4) && v(r4), e3.state) {
            case "running":
              l2 = Date.now(), s3 && d2();
              break;
            case "suspended":
              document.hidden || u2++, s3 && u2 >= t3 ? c3(j("suspended")) : setTimeout(f2, n3);
          }
        } catch (i4) {
          c3(i4);
        }
    ...
    return [o3, a3];
  }(n2), o2 = a2[0], c2 = a2[1], s2 = o2.then(function(e3) {
    return function(e4) {
      ...
      return s(this, function(r2) {
        switch (r2.label) {
          case 0:
            return [4, t2()];
          case 1:
            return e3 = r2.sent(), [2, [(n2 = function(e4) {
              return null === e4 ? null : W(e4, 10);
  ...
  var e2, t2 = navigator, n2 = [], r2 = t2.language || t2.userLanguage || t2.browserLanguage || t2.systemLanguage;
  if (void 0 !== r2 && n2.push([r2]), Array.isArray(t2.languages))
    I() && x([!("MediaSettingsRange" in (e2 = window)), "RTCEncodedAudioFrame" in e2, "" + e2.Intl == "[object Intl]", "" + e2.Reflect == "[object Reflect]"]) >= 3 || n2.push(t2.languages);
  ...
  var e2, t2;
  if (!(M() || (e2 = window, t2 = navigator, x(["msWriteProfilerMark" in e2, "MSStream" in e2, "msLaunchUri" in t2, "msSaveBlob" in t2]) >= 3 && !M())))
    try {
  ...
  return "MacIntel" === e2 && A() && !F() ? function() {
    if ("iPad" === navigator.platform)
      return true;
    var e3 = screen, t2 = e3.width / e3.height;
    return x(["MediaSource" in window, !!Element.prototype.webkitRequestFullscreen, t2 > 0.65 && t2 < 1.53]) >= 2;
  }() ? "iPad" : "iPhone" : e2;
}, plugins: function() {
  ...
  if (e2) {
    for (var t2 = [], n2 = 0; n2 < e2.length; ++n2) {
      ...
      if (r2) {
        ...
        t2.push({ name: r2.name, description: r2.description, mimeTypes: i2 });
      }
    }
    return t2;
  }
}, canvas: function() {
  var e2, t2, n2 = false, r2 = function() {
  ...
  if (function(e3, t3) {
    ...
    var o2 = D(i2);
    o2 !== D(i2) ? e2 = t2 = "unstable" : (t2 = o2, function(e3, t3) {
      ...
      for (var n3 = 0, r3 = [["#f2f", 40, 40], ["#2ff", 80, 40], ["#ff2", 60, 80]]; n3 < r3.length; n3++) {
        ...
        t3.fillStyle = a3, t3.beginPath(), t3.arc(o3, c2, 40, 0, 2 * Math.PI, true), t3.closePath(), t3.fill();
      }
  ...
  void 0 !== t2.maxTouchPoints ? n2 = k(t2.maxTouchPoints) : void 0 !== t2.msMaxTouchPoints && (n2 = t2.msMaxTouchPoints);
  try {
  ...
  for (var e2 = [], t2 = 0, n2 = ["chrome", "safari", "__crWeb", "__gCrWeb", "yandex", "__yb", "__ybro", "__firefox__", "__edgeTrackingPreventionStatistics", "webkit", "oprt", "samsungAr", "ucweb", "UCShellJava", "puffinDevice"]; t2 < n2.length; t2++) {
    var r2 = n2[t2], i2 = window[r2];
    i2 && "object" == typeof i2 && e2.push(r2);
  }
  return e2.sort();
  ...
  var e2, t2 = re.acos || ie, n2 = re.acosh || ie, r2 = re.asin || ie, i2 = re.asinh || ie, a2 = re.atanh || ie, o2 = re.atan || ie, c2 = re.sin || ie, s2 = re.sinh || ie, u2 = re.cos || ie, l2 = re.cosh || ie, d2 = re.tan || ie, m2 = re.tanh || ie, f2 = re.exp || ie, h2 = re.expm1 || ie, v2 = re.log1p || ie;
  return { acos: t2(0.12312423423423424), acosh: n2(1e308), acoshPf: (e2 = 1e154, re.log(e2 + re.sqrt(e2 * e2 - 1))), asin: r2(0.12312423423423424), asinh: i2(1), asinhPf: function(e3) {
    return re.log(e3 + re.sqrt(e3 * e3 + 1));
  }(1), atanh: a2(0.5), atanhPf: function(e3) {
    return re.log((1 + e3) / (1 - e3)) / 2;
  }(0.5), atan: o2(0.5), sin: c2(-1e300), sinh: s2(1), sinhPf: function(e3) {
    return re.exp(e3) - 1 / re.exp(e3) / 2;
  }(1), cos: u2(10.000000000123), cosh: l2(1), coshPf: function(e3) {
    return (re.exp(e3) + 1 / re.exp(e3)) / 2;
  }(1), tan: d2(-1e300), tanh: m2(1), tanhPf: function(e3) {
    return (re.exp(2 * e3) - 1) / (re.exp(2 * e3) + 1);
  }(1), exp: f2(1), expm1: h2(1), expm1Pf: function(e3) {
    return re.exp(e3) - 1;
  }(1), log1p: v2(10), log1pPf: function(e3) {
    return re.log(1 + e3);
  }(10), powPI: function(e3) {
    return re.pow(re.PI, e3);
  }(-100) };
}, videoCard: function() {
...
function se(e2) {
  var t2 = function(e3) {
    ...
    return W(0.99 + 0.01 * e3, 1e-4);
  }(t2);
  return { score: t2, comment: ce.replace(/\$/g, "".concat(n2)) };
}
function ue(e2) {
  return JSON.stringify(e2, function(e3, t2) {
    return t2 instanceof Error ? o({ name: (n2 = t2).name, message: n2.message, stack: null === (r2 = n2.stack) || void 0 === r2 ? void 0 : r2.split("\n") }, n2) : t2;
    var n2, r2;
  }, 2);
}
function le(e2) {
  return function(e3, t2) {
    t2 = t2 || 0;
    var n2, r2 = (e3 = e3 || "").length % 16, i2 = e3.length - r2, a2 = [0, t2], o2 = [0, t2], c2 = [0, 0], s2 = [0, 0], u2 = [2277735313, 289559509], l2 = [1291169091, 658871167];
    for (n2 = 0; n2 < i2; n2 += 16)
      c2 = [255 & e3.charCodeAt(n2 + 4) | (255 & e3.charCodeAt(n2 + 5)) << 8 | (255 & e3.charCodeAt(n2 + 6)) << 16 | (255 & e3.charCodeAt(n2 + 7)) << 24, 255 & e3.charCodeAt(n2) | (255 & e3.charCodeAt(n2 + 1)) << 8 | (255 & e3.charCodeAt(n2 + 2)) << 16 | (255 & e3.charCodeAt(n2 + 3)) << 24], s2 = [255 & e3.charCodeAt(n2 + 12) | (255 & e3.charCodeAt(n2 + 13)) << 8 | (255 & e3.charCodeAt(n2 + 14)) << 16 | (255 & e3.charCodeAt(n2 + 15)) << 24, 255 & e3.charCodeAt(n2 + 8) | (255 & e3.charCodeAt(n2 + 9)) << 8 | (255 & e3.charCodeAt(n2 + 10)) << 16 | (255 & e3.charCodeAt(n2 + 11)) << 24], c2 = b(c2 = y(c2, u2), 31), a2 = p(a2 = b(a2 = w(a2, c2 = y(c2, l2)), 27), o2), a2 = p(y(a2, [0, 5]), [0, 1390208809]), s2 = b(s2 = y(s2, l2), 33), o2 = p(o2 = b(o2 = w(o2, s2 = y(s2, u2)), 31), a2), o2 = p(y(o2, [0, 5]), [0, 944331445]);
    switch (c2 = [0, 0], s2 = [0, 0], r2) {
      case 15:
        s2 = w(s2, g([0, e3.charCodeAt(n2 + 14)], 48));
      case 14:
        s2 = w(s2, g([0, e3.charCodeAt(n2 + 13)], 40));
      case 13:
        s2 = w(s2, g([0, e3.charCodeAt(n2 + 12)], 32));
      case 12:
        s2 = w(s2, g([0, e3.charCodeAt(n2 + 11)], 24));
      case 11:
        s2 = w(s2, g([0, e3.charCodeAt(n2 + 10)], 16));
      case 10:
        s2 = w(s2, g([0, e3.charCodeAt(n2 + 9)], 8));
      case 9:
        s2 = y(s2 = w(s2, [0, e3.charCodeAt(n2 + 8)]), l2), o2 = w(o2, s2 = y(s2 = b(s2, 33), u2));
      case 8:
        c2 = w(c2, g([0, e3.charCodeAt(n2 + 7)], 56));
      case 7:
        c2 = w(c2, g([0, e3.charCodeAt(n2 + 6)], 48));
      case 6:
        c2 = w(c2, g([0, e3.charCodeAt(n2 + 5)], 40));
      case 5:
        c2 = w(c2, g([0, e3.charCodeAt(n2 + 4)], 32));
      case 4:
        c2 = w(c2, g([0, e3.charCodeAt(n2 + 3)], 24));
      case 3:
        c2 = w(c2, g([0, e3.charCodeAt(n2 + 2)], 16));
      case 2:
        c2 = w(c2, g([0, e3.charCodeAt(n2 + 1)], 8));
      case 1:
        c2 = y(c2 = w(c2, [0, e3.charCodeAt(n2)]), u2), a2 = w(a2, c2 = y(c2 = b(c2, 31), l2));
    }
    return a2 = p(a2 = w(a2, [0, e3.length]), o2 = w(o2, [0, e3.length])), o2 = p(o2, a2), a2 = p(a2 = L(a2), o2 = L(o2)), o2 = p(o2, a2), ("00000000" + (a2[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (a2[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (o2[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (o2[1] >>> 0).toString(16)).slice(-8);
  }(function(e3) {
    for (var t2 = "", n2 = 0, r2 = Object.keys(e3).sort(); n2 < r2.length; n2++) {
      var i2 = r2[n2], a2 = e3[i2], o2 = a2.error ? "error" : JSON.stringify(a2.value);
      t2 += "".concat(t2 ? "|" : "").concat(i2.replace(/([:|\\])/g, "\\$1"), ":").concat(o2);
    }
    return t2;
  }(e2));
}
  ...
  return { get: function(r2) {
    return c(this, void 0, void 0, function() {
      ...
      return s(this, function(c2) {
        switch (c2.label) {
          case 0:
            return i2 = Date.now(), [4, e2()];
          case 1:
            return a2 = c2.sent(), o2 = function(e3) {
              var t3, n3 = se(e3);
              return { get visitorId() {
                return void 0 === t3 && (t3 = le(this.components)), t3;
              }, set visitorId(e4) {
                t3 = e4;
              }, confidence: n3, components: e3, version: l };
            }(a2), (t2 || (null == r2 ? void 0 : r2.debug)) && console.log("Copy the text below to get the debug data:\n\n```\nversion: ".concat(o2.version, "\nuserAgent: ").concat(navigator.userAgent, "\ntimeBetweenLoadAndGet: ").concat(i2 - n2, "\nvisitorId: ").concat(o2.visitorId, "\ncomponents: ").concat(ue(a2), "\n```")), [2, o2];
        }
      });
    });
  } };
...
function fe(e2) {
  var t2 = void 0 === e2 ? {} : e2, n2 = t2.delayFallback, r2 = t2.debug, i2 = t2.monitoring, a2 = void 0 === i2 || i2;
  return c(this, void 0, void 0, function() {
          ...
          return a2 && function() {
            if (!(window.__fpjs_d_m || Math.random() >= 1e-3))
              try {
                ...
                e4.open("get", "https://m1.openfpcdn.io/fingerprintjs/v".concat(l, "/npm-monitoring"), true), e4.send();
              } catch (t3) {
                console.error(t3);
              }
          }(), [4, de(n2)];
        case 1:
          return e3.sent(), [2, me(C(oe, { debug: r2 }, []), r2)];
      }
    });
  });
}
...
var ve = "0123456789ABCDEFGHJKMNPQRSTVWXYZ", pe = ve.length, ye = Math.pow(2, 48) - 1;
function be(e2) {
  var t2 = Math.floor(e2() * pe);
  return t2 === pe && (t2 = pe - 1), ve.charAt(t2);
}
var ge, we = (ge || (ge = function() {
  ...
  throw he("secure crypto unusable, insecure Math.random not allowed");
}()), function(e2) {
  return isNaN(e2) && (e2 = Date.now()), function(e3, t2) {
    if (isNaN(e3))
      throw new Error(e3 + " must be a number");
    if (e3 > ye)
      throw he("cannot encode time greater than " + ye);
    if (e3 < 0)
      throw he("time must be positive");
    if (false === Number.isInteger(e3))
      throw he("time must be an integer");
    for (var n2 = void 0, r2 = ""; t2 > 0; t2--)
      n2 = e3 % pe, r2 = ve.charAt(n2) + r2, e3 = (e3 - n2) / pe;
    return r2;
...
class Le {
  constructor(t2 = []) {
    ...
    this.cmd = new e(t2), this.dataLayer = new a(), this.options = this.parseOptions();
  }
  get fp() {
  ...
  async initialize() {
    return this.identity.fingerprint = (await (await fe()).get()).visitorId, this.dataLayer.set("fp", this.identity.fingerprint), this.viewId = we().toLowerCase(), this.dataLayer.set("traceId", this.viewId), await this.cmd.execute().catch(), this.ready = true, await this.collect(t.WebVisit).catch(), this.options.poll && this.setInterval(), this;
  }
  async collect(e2, t2 = {}) {
    t2 = { ...this.data, ...t2 }, this.data = {};
    try {
      await fetch("https://qe.traction.technologyadvice.com/ngt/collect", { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ event: e2, trace_id: this.viewId, identity: this.identity, data: { ...t2, url: window.location.href }, triggered_at: Date.now() }) });
    } catch (n2) {
      console.error(`Failed to submit track, ${n2}`);
    }
  }
  setData(e2, t2, n2 = false) {
    this.data[e2] = t2, n2 || this.poll;
  }
  setTaxonomy(e2, t2) {
    var _a;
  ...
  setInterval() {
    ...
    const t2 = async (n2 = 2) => {
      var _a, _b;
      e2 += this.options.pollInterval, ((_a = this.seen) == null ? void 0 : _a.cmsData) || this.ingestCmsData(), ((_b = this.seen) == null ? void 0 : _b.sixSenseData) || this.ingestSixSenseData(), await this.heartbeat(e2), 0 === n2 && (this.options.pollInterval = Math.min(6e4, 2 * this.options.pollInterval), n2 = 2), e2 < 36e5 && setTimeout(() => {
        t2(n2 - 1);
  ...
  ingestCmsData() {
    const e2 = this.dataLayer.all().find(({ event: e3 }) => "CMS_Data" === e3);
    if (!e2)
      return;
    let t2 = (e2 == null ? void 0 : e2.topic) ?? "";
    "string" == typeof t2 && (t2 = this.transformStringifiedArray(t2));
    let n2 = (e2 == null ? void 0 : e2.category) ?? [];
    "string" == typeof n2 && (n2 = this.transformStringifiedArray(n2)), this.seen.cmsData = true, this.setTaxonomy(r.Topic, t2), this.setTaxonomy(r.Category, n2);
  }
  ingestSixSenseData() {
    const e2 = this.dataLayer.all().reduce((e3, t2) => {
    ...
    (e2.sixSense || e2.segments) && (this.seen.sixSenseData = true, this.setData("sixSense", Object.fromEntries(Object.entries(e2.sixSense).filter(([e3, t2]) => "" !== t2 && null != t2))), this.setTaxonomy(r.SixSenseSegment, e2.segments.segment_ids));
  }
...
!async function() {
  ...
  const e2 = window.ngt = new Le(window.ngt.cmd);
  await e2.initialize();
}();
