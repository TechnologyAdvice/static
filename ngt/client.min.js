...
class Le {
  ...
  async collect(e2, t2 = {}) {
    ...
    try {
      await fetch("https://traction.technologyadvice.com/ngt/collect", { method: "POST", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({ event: e2, trace_id: this.viewId, identity: this.identity, data: { ...t2, url: window.location.href }, triggered_at: Date.now() }) });
    } catch (n2) {
